...
import { calculateEscapeRisk, formatMorningValueProfile, getMorningValueProfile } from "./kaime.js";
...
export async function runDailyPick() {
  ...
  try {
    ...
    console.log(`[done] scanned=${targets.length} parsed=${parsedCount} noData=${noDataCount} failed=${failureCount} matched=${matchedResults.length} discordMessages=${discordMessageCount}`);
  } finally {
